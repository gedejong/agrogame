...
def test_compute_water_stress_basic():
...
def test_stress_calculator_combine_methods():
...
def test_nutrient_from_uptake_demand():
...
def test_nutrient_from_concentration_piecewise():
    calc = StressCalculator()
    # Below critical -> 0
    assert (
